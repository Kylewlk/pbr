...
IblTextureScene::IblTextureScene(int width, int height)
    : Base3DScene(ID, width, height, true)
{
    ...
    IblTextureScene::reset();
}

SceneRef IblTextureScene::create()
{
    struct enable_make_shared : public IblTextureScene
    {
        enable_make_shared() : IblTextureScene(0, 0) {}
    };
    return std::make_shared<enable_make_shared>();
}

void IblTextureScene::reset()
{
...
void IblTextureScene::draw()
{
    ...
    this->materials[materialType].use(shaderIblTexture);

    shaderIblTexture->setUniform("model", math::translate({-80, 0, 0}) * mat);
    renderSphere();
...
void IblTextureScene::drawSkyBox(const TextureRef& cubeMap, int lod /*= -1*/)
{
...
void IblTextureScene::drawSettings()
{
...
void IblTextureScene::createCubMap(const TextureRef& hdr, TextureRef& cubeMap)
{
...
void IblTextureScene::createPrefilter(const TextureRef& cubeMap, TextureRef& prefilter)
{
...
void IblTextureScene::createBrdfLut()
{
