...
public:
    ...
    static TextureRef createWithMipmap(const std::string& picPath, bool premultiply);
    static TextureRef create(const ByteBuffer& picData, bool genMipmap, bool premultiply);
